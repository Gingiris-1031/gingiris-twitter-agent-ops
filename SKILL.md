...
description: |
  ...
  🇨🇳 知道每天该发推，但写推文吃掉整个晚上——让 AI 代写，发出来又完全不像你。这套 SOP 让任何 AI agent 变成「像你本人」的推特代笔人：人设校准、素材库、排期、红线规则、发布前质检、数据复盘全流程，真实账号 45 天涨粉 60% 验证。v2.0 新增：AI腔黑名单建立方法、X算法冷启动窗口最优时段、连发间隔红线。
